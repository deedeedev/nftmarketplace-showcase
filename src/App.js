    ...
    return (
        <>
            ...
            <SectionWrapper
                ...
                description="The app contains two screens. The first screen lists all the NFTs while the second one shows the details of a specific NFT."
            ...
            <div className="px-4 py-2 justify-center item-center bg-primary flex-col text-center banner04">
                <p className={`${styles.pText} ${styles.whiteText}`}>
                    Made with love by {"&nbsp;"}
                    <span className="bold">DeeDeeDev</span>
                </p>
            </div>
        </>
    );
